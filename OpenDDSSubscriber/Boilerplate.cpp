...
namespace boilerplate {
    ...
    DDS::DomainParticipant_var createParticipant(DDS::DomainParticipantFactory_var dpf)
    {
    ...
    DDS::Topic_var createTopic(DDS::DomainParticipant_var participant)
    {
        ...
        // Create Topic (FixedID endpoint)
        CORBA::String_var type_name = ts->get_type_name();
        DDS::Topic_var topic =
                participant->create_topic("FixedID endpoint",
                                          type_name,
                                          TOPIC_QOS_DEFAULT,
                                          0,
                                          OpenDDS::DCPS::DEFAULT_STATUS_MASK);
