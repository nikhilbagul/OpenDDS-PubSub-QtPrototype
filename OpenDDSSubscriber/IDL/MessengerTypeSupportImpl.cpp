/* Generated by /Users/nikhil.bagul/OpenDDS/OpenDDS-3.13.2/bin/opendds_idl version 3.13.2 (ACE version 6.2a_p15) running on input file Messenger.idl */
...
void gen_find_size(const Messenger::Message& stru, size_t& size, size_t& padding)
{
  ...
  size += ACE_OS::strlen(stru.fixed_id.in()) + 1;
  find_size_ulong(size, padding);
...
struct MetaStructImpl<Messenger::Message> : MetaStruct {
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "fixed_id") == 0) {
      return typed.fixed_id.in();
    }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    if (std::strcmp(field, "fixed_id") == 0) {
      ...
      if (!(ser >> val.out())) {
        throw std::runtime_error("Field 'fixed_id' could not be deserialized");
      }
      return val;
    } else {
      ACE_CDR::ULong len;
      if (!(ser >> len)) {
        throw std::runtime_error("String 'fixed_id' length could not be deserialized");
      }
      if (!ser.skip(static_cast<ACE_UINT16>(len))) {
        throw std::runtime_error("String 'fixed_id' contents could not be skipped");
      }
    }
    if (std::strcmp(field, "type") == 0) {
      TAO::String_Manager val;
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ACE_UNUSED_ARG(next);
    if (std::strcmp(field, "fixed_id") == 0) {
      return make_field_cmp(&T::fixed_id, next);
    }
    if (std::strcmp(field, "type") == 0) {
  ...
  {
    static const char* names[] = {"fixed_id", "type", "value", 0};
    return names;
  }
  ...
  {
    if (std::strcmp(field, "fixed_id") == 0) {
      return &static_cast<const T*>(stru)->fixed_id;
    }
    if (std::strcmp(field, "type") == 0) {
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "fixed_id") == 0) {
      static_cast<T*>(lhs)->fixed_id = *static_cast<const TAO::String_Manager*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "type") == 0) {
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    ACE_UNUSED_ARG(rhs);
    if (std::strcmp(field, "fixed_id") == 0) {
      return 0 == ACE_OS::strcmp(static_cast<const T*>(lhs)->fixed_id.in(), static_cast<const T*>(rhs)->fixed_id.in());
    }
    if (std::strcmp(field, "type") == 0) {
